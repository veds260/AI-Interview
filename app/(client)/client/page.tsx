  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="group border-2 border-transparent hover:border-red-500/30 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 bg-gradient-to-br from-gray-900/50 to-gray-800/50">
          <CardHeader className="pb-4">
            <div className="w-12 h-12 bg-red-500/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-red-500/20 transition-colors duration-300">
        ...
        <Card className="group border-2 border-transparent hover:border-emerald-500/30 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 bg-gradient-to-br from-gray-900/50 to-gray-800/50">
          <CardHeader className="pb-4">
            <div className="w-12 h-12 bg-emerald-500/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-emerald-500/20 transition-colors duration-300">
          ...
          <CardContent>
            <Link href="/client/interview/start?mode=text_chat">
              <Button variant="outline" className="w-full border-emerald-500/30 text-emerald-500 hover:bg-emerald-500/10 hover:border-emerald-500/50">
